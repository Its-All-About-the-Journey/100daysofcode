...
"Virginia", "New York", "North Carolina", "Rhode Island", "Vermon", "Kentucky", 
...
## Prints the amount of states, in this case 50. Index starts at 0
print(len(states_of_america))

## Prints the last item in the this list ie Hawaii
