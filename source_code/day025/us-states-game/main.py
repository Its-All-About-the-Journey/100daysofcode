...
image = "source_code/day025/us-states-game/blank_states_img.gif"
screen.addshape(image)
turtle.shape(image)

states = pandas.read_csv("source_code/day025/us-states-game/50_states.csv")
remaining_states = pandas.read_csv("source_code/day025/us-states-game/remaining_states.csv")
...
def guess(x, y):
    ...
    if guess == "Exit":
        ...
        for guess in guesses:
            remaining_states = remaining_states[remaining_states.state != guess]
        remaining_states.to_csv("source_code/day025/us-states-game/remaining_states.csv")
        exit()
...
def check_for_win():
    if len(guesses) == len(all_states):
        ...
        states.to_csv("source_code/day025/us-states-game/remaining_states.csv")
